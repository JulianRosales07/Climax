          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="bg-green-50 p-3 rounded-lg">
                ...
                <p className="text-lg font-bold text-green-600">${totalSalesByMethod.efectivo.toFixed(2)}</p>
              </div>
              <div className="bg-purple-50 p-3 rounded-lg">
                <h4 className="text-sm font-medium text-purple-800">Nequi</h4>
                <p className="text-lg font-bold text-purple-600">${totalSalesByMethod.nequi.toFixed(2)}</p>
              </div>
              <div className="bg-orange-50 p-3 rounded-lg">
                <h4 className="text-sm font-medium text-orange-800">Datáfono</h4>
                <p className="text-lg font-bold text-orange-600">${totalSalesByMethod.datafono.toFixed(2)}</p>
              </div>
            </div>
          </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {sales.map((sale) => (
                    <tr key={sale.id}>
                      ...
                      <td className="px-4 py-2 text-sm font-medium text-gray-900">${sale.totalPrice.toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
